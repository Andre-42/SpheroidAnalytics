...
def create_model():
    data_unnormalized = keras.Input(shape=(1080,1080,3), name="data_unnormalized")
    ...
    dec_crop1 = layers.Cropping2D(cropping=((1,1),(1,1)))(dec_upsample1)
    ...
    scorer = layers.Conv2D(3, (1,1), name="scorer_")(dec_relu4)
    dec_upsample2 = layers.Conv2DTranspose(3, (8,8), strides=(4,4), name="dec_upsample2_")(scorer)
    ...
    model = keras.Model(inputs=[data_unnormalized], outputs=[labels])
    return model
