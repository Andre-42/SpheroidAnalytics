...
* To load the model with weights:
    ...
    import modelSegDeadOrAliveVers1
    model = modelSegDeadOrAliveVers1.load_model()


* To load the model without weights:

    import modelSegDeadOrAliveVers1
    model = modelSegDeadOrAliveVers1.load_model(load_weights=False)
